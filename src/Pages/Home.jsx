      ...
      <div className='grid grid-cols-1 px-5 sm:pr-10 lg:mb-5 sm:grid-cols-2 py-5 bg-slate-500' >
        <div className=' items-center justify-center px-5 py-28 bg-slate-500'>
          ...
          <div className=' mt-4 flex pl-0 bg-slate-500 justify-left lg:gap-10 gap-4  lg:pr-44'>
            <Link to='/login' className=' py-2 pl-10 mx md:px-11 lg:px-11  font-bold w-full  hover:bg-[#212245] duration-300 bg-teal-500 sm:w-32 h-10 rounded-lg'>Mulai</Link>
            <Link to='/service' className=' font-bold w-full border-2 py-1  px-1 md:px-4 lg:px-4 hover:text-teal-200 duration-300 hover:border-x-teal-200 hover:border-y-teal-200 bg-slate-500 sm:w-32 h-10 rounded-lg'>Cek Service</Link>
          </div>
        </div>
        ...
        <div className='px-4 bg-slate-400 mb-20 items-center justify-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4'>
          <div class="p-4 m-7 lg:w-64 bg-slate-500 shadow-md rounded-xl">
            <picture class=" bg-slate-500 rounded-lg block">
              <img
                src={logo} alt='' className=' bg-slate-500 hover:scale-125 rounded-lg my-3 mx-10 duration-300 h-40'
              />
            </picture>
        ...
        <div className=' mb-32 grid text-center  lg:mx-20 items-center justify-center'>
          <div class="p-4 px-10 mx-4 bg-slate-400 shadow-md rounded-xl lg:mx-20 lg:w-[800px] m-10 md:px-5">
            <picture class=" bg-slate-400 rounded-lg block">
              <img
                src={Contact} alt='' className=' bg-slate-400 w-auto lg:mx-[300px] md:mx-36 md:hover:scale-125 duration-300 bg-transparent cursor-pointer hover:scale-125 sm:px-2 sm:h-auto my-3 lg:h-40'
              />
            </picture>
