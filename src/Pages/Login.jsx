...
const Login = () => {
    return (
        <Helmet title='Login' >
            <h1 className='px-7 py-7 pl-10 text-3xl lg:my-5 mb-8 font-extrabold w-screen bg-slate-400'>Login</h1>
            <div className='grid grid-cols-1 items-center justify-center sm:w-[300px] md:mx-[210px] lg:mx-[460px] p-4 lg:my-20 lg:mb-40 lg:px-10 m-8 lg:w-[350px] h-[200px] bg-slate-600 ' >
